...
Route::get('articles/download/{file}', [ArticleController::class, 'download'])->name('articles.download'); // 첨부파일
Route::get('download/excel', [ArticleController::class, 'excel'])->name('download.excel'); // Excel 다운로드
Route::get('download/excel/csv', [ArticleController::class, 'csv'])->name('download.excel.csv'); // CSV 다운로드(SimpleExcel)
Route::post('download/excel/filtering', [ArticleController::class, 'filtering'])->name('download.excel.filtering'); // 엑셀 필터링 다운로드(SimpleExcel)
Route::get('download/fastExcel', [ArticleController::class, 'fastExcel'])->name('download.fastExcel'); // FastExcel 다운로드
Route::get('excel/data_count', [ArticleController::class, 'data_count'])->name('excel.data_count'); // 데이터 개수 조회
Route::get('articles/{article}/pdf', [ArticleController::class, 'pdf'])->name('articles.pdf'); // PDF 다운로드
